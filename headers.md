...
Refpack is also used in TT Fusion's Lego games on the PSP and DS consoles[^lego]. It likely obtained the algorithm through its predecessor, Warthog Games, which developed some games published by EA.
